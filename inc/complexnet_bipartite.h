...
//following functions are used with args.
//they are utility functions.
//abstractUser_Bipartite will abstract one edge from each user and return.
//the arg bip will be changed, all abstracted edges will be deleted in the arg bip.
//abstractItem_Bipartite acts same as abstractUser_Bipartite.
struct i4LineFile *abstractUser_Bipartite(struct Bipartite *bip);
struct i4LineFile *abstractItem_Bipartite(struct Bipartite *bip);
