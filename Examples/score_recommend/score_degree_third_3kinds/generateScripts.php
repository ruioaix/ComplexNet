<?php
  ...
  // ($filenamePre == 'movielens') {
    ...
    $mass_rank = 0.092687;
    $mass_precision = 0.098539;
    $mass_intrasimilarity = 0.319445;
    $mass_hammingd = 0.842276;
    $mass_popularity = 175.56;
    $mass_score = 3.596291;
...
plot '$outputdir/$datafile_score' using 3:17 w lp pt 19 ps 0.2 lc 3 title 'averagescore_score', '$outputdir/$datafile_degree' using 3:17 w lp pt 19 ps 0.2 lc 4 title 'averagescore_degree', '$outputdir/$datafile_third' using 3:17 w lp pt 19 ps 0.2 lc 1 title 'averagescore_third', $best_score with points pt 18 ps 0.2 title 'best hybrid $best_lambda', $mass_score with points pt 18 ps 0.2 title 'mass'
set output

set xlabel 'theta'
set ylabel 'RankScore'
set output '$outputdir/RankScore_3kinds_$filenamePre.eps'
plot '$outputdir/$datafile_score' using 3:7 w lp pt 19 ps 0.2 lc 3 title 'RankScore_score', '$outputdir/$datafile_degree' using 3:7 w lp pt 19 ps 0.2 lc 4 title 'RankScore_degree', '$outputdir/$datafile_third' using 3:7 w lp pt 19 ps 0.2 lc 1 title 'RankScore_third', $best_rank with points pt 18 ps 0.2 title 'best hybrid $best_lambda', $mass_rank with points pt 18 ps 0.2 title 'mass'
set output

set xlabel 'theta'
set ylabel 'Precision'
set output '$outputdir/Precision_3kinds_$filenamePre.eps'
plot '$outputdir/$datafile_score' using 3:9 w lp pt 19 ps 0.2 lc 3 title 'Precision_score', '$outputdir/$datafile_degree' using 3:9 w lp pt 19 ps 0.2 lc 4 title 'Precision_degree', '$outputdir/$datafile_third' using 3:9 w lp pt 19 ps 0.2 lc 1 title 'Precision_third', $best_precision with points pt 18 ps 0.2 title 'best hybrid $best_lambda', $mass_precision with points pt 18 ps 0.2 title 'mass'
set output

set xlabel 'theta'
set ylabel 'Intrasimilarity'
set output '$outputdir/Intrasimilarity_3kinds_$filenamePre.eps'
plot '$outputdir/$datafile_score' using 3:11 w lp pt 19 ps 0.2 lc 3 title 'Intrasimilarity_score', '$outputdir/$datafile_degree' using 3:11 w lp pt 19 ps 0.2 lc 4 title 'Intrasimilarity_degree', '$outputdir/$datafile_third' using 3:11 w lp pt 19 ps 0.2 lc 1 title 'Intrasimilarity_third', $best_intrasimilarity with points pt 18 ps 0.2 title 'best hybrid $best_lambda', $mass_intrasimilarity with points pt 18 ps 0.2 title 'mass'
set output

set xlabel 'theta'
set ylabel 'HammingD'
set output '$outputdir/HammingD_3kinds_$filenamePre.eps'
plot '$outputdir/$datafile_score' using 3:13 w lp pt 19 ps 0.2 lc 3 title 'HammingD_score', '$outputdir/$datafile_degree' using 3:13 w lp pt 19 ps 0.2 lc 4 title 'HammingD_degree', '$outputdir/$datafile_third' using 3:13 w lp pt 19 ps 0.2 lc 1 title 'HammingD_third', $best_hammingd with points pt 18 ps 0.2 title 'best hybrid $best_lambda', $mass_hammingd with points pt 18 ps 0.2 title 'mass'
set output

set xlabel 'theta'
set ylabel 'Popularity'
set output '$outputdir/Popularity_3kinds_$filenamePre.eps'
plot '$outputdir/$datafile_score' using 3:15 w lp pt 19 ps 0.2 lc 3 title 'Popularity_score', '$outputdir/$datafile_degree' using 3:15 w lp pt 19 ps 0.2 lc 4 title 'Popularity_degree', '$outputdir/$datafile_third' using 3:15 w lp pt 19 ps 0.2 lc 1 title 'Popularity_third', $best_popularity with points pt 18 ps 0.2 title 'best hybrid $best_lambda', $mass_popularity with points pt 18 ps 0.2 title 'mass'
set output
...
");
  ...
  //php generateScripts.php movielens 0.02 5 2.01 data/movielens/movielens_3c 100 scripts_movielens 5 0.15
